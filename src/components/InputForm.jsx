  ...
  return (
    <div className="w-full  sm:h-[750px] lg:h-[620px] xl:h-[550px] flex flex-col items-center bg-transparent">
        ...
        msg.length === 0 && (
          <div className='p-5 mt-5 text-center md:w-[400px]'>
            <div className='w-50 h-50 mx-auto'>
              <img src="./src/assets/image/logo.png" alt="AI Logo" className='w-full h-full object-cover'/>
            </div>
            <div>
              <h1 className='text-2xl font-bold'>Welcome to AI Assistant</h1>
              <p className='text-gray-500 text-lg'>I'm here to help you with questions, provide information, and assist with various tasks. What would you like to know?</p>
            </div>
          </div>
        )
      }
            ...
            {m.role === 'user' ? (
              <div className='flex justify-end'>
                ...
                <div className='w-[40px] h-[40px] bg-gray-500 ms-2 rounded-full overflow-hidden border-2 border-blue-950 '>
                  <img src="https://i.ytimg.com/vi/j1YEVm5M-YM/maxresdefault.jpg" className='w-full h-full object-cover' alt="" />
                </div>
              </div>
            ) : (
      ...
      <div className='w-full md:w-[80%] px-4 py-4 fixed bottom-0 rounded-full overflow-hidden '>
        <form onSubmit={handleSend} className='flex bg-gray-200 rounded-full overflow-hidden'>
          <input
            disabled={isloading}
            type="text"
